...
for (i in 1:length(info)) {
  ...
  <<est>>
    ...
    file_name <- file.path(getwd(), "interim", paste0(file_stem, "_gaps_cv_", phase, "_", sprintf("%.2f", i), ".csv"))
    run_placebo <- T
  <<placebo>>
  ...
  cat("\n\n")
  # determine output filename
  file_name <- file.path(getwd(), "interim", paste0(file_stem, "_gaps_sim_", phase, "_", sprintf("%.2f", i), ".csv"))
  run_placebo <- T
  <<placebo>>
