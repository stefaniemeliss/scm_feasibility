...
#### SC - evaluate results ####
summarise_scest(scest.out, id_treated = id_treated, id_name = id_name, cv = T)
...
file_name <- file.path(dir, "02_scm", "interim", paste0(file_stem, "_gaps_cv_", setting, "_", gsub(" ", "_", id_name), ".csv"))
