...
df <- read.csv(file = file.path(dir_data, "school-workforce-in-england_2023", "data", "workforce_2010_2023_fte_hc_nat_reg_la_sch.csv"))
...
# Trellis plot
plt <- ggplot(data = df, aes(x = time_period, y = get(dep_var), group = school_urn, col = school_urn, fill = school_urn)) +
  geom_point() + 
  geom_line() + 
  geom_area(alpha=0.6) +
  facet_wrap("school_urn") +
  ambition_theme + theme(legend.position = "none",  
