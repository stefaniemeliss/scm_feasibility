...
leav <- read.csv(file = file.path(gsub("scm_feasibility", "edu_stats", dir_data), "school-workforce-in-england", "2023", "data", "workforce_qual_leavers_2010_2022_national.csv"))
...
# edit data 
leav$time_period <- insert_slash(leav$time_period)
...
fte <- read.csv(file = file.path(gsub("scm_feasibility", "edu_stats", dir_data), "school-workforce-in-england", "2023", "data", "workforce_2010_2023_fte_hc_nat_reg_la.csv"))
...
dict <- structure(list(Variable.name = c("age_group", "ethnicity_major", 
                                         "fte_leavers", "fte_leavers_percent", "gender", "grade", "leaver_type", 
                                         "school_type", "working_pattern"), Variable.description = c("Age group", 
                                                                                                     "Ethnicity major", "FTE number of leavers", "Leavers rate", "Gender", 
                                                                                                     "Post on leaving", "Type of leaver", "Type of school", "Working pattern"
...
for (var in vars) {
  ...
  for (dep_var in dep_vars) {
    ...
    plt <- ggplot(data = df, aes(x = time_period, y = get(dep_var), group = get(var), col = get(var))) +
      ...
      ylab(paste(y_lab)) + xlab("Academic year") + 
