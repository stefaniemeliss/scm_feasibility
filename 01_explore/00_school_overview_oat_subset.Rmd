...
# select only subset of OAT schools
df <- df %>% filter(phase_type_grouping == "State-funded secondary",
                    grepl("Urban", urban_rural))

```

> Only secondary schools in urban regions included.  
