...
df <- xlsx::read.xlsx(file = file.path(dir, "government_data.xlsx"), sheetName = "data_OAT")
...
> In order to create a more homogeneous donor pool, suggestion to focus on  
> -    Secondary schools  
> -    Urban regions (all Dixon schools are in Urban regions)  
...
# missing data
note <- "Data from the following schools is not available: "
schools <- paste(df$establishment.name[is.na(df$estab_gias)], collapse = ", ")
