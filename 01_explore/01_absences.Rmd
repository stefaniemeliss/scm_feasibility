...
df <- read.csv(file = file.path(dir, "data", "school-workforce-in-england_2023", "data", "sickness_absence_teachers_sch.csv"))
names(df) <- gsub("X...", "", names(df), fixed = T)

# read in info about dataset
dict <- read.csv(file = file.path(dir, "misc", "meta_absences.csv"))
