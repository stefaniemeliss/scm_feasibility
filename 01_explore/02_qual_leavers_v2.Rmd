...
dict[nrow(dict) + 1, ] <- c("fte_all_teachers_percent", "Proportion of leavers wrt national teacher workforce")
...
dep_var <- "fte_leavers_percent"

<<working_chunk>>

cat("\n\n")

dep_var <- "fte_all_teachers_percent"
