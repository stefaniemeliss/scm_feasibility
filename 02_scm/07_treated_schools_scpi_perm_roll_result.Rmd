...
file_name <- file.path(dir, "02_scm", paste0("06_treated_schools_scpi_perm_roll_", gsub(" ", "_", id_name), "_simdata.csv"))
...
# determine input filename
file_name <- file.path(dir, "02_scm", paste0("06_treated_schools_scpi_perm_roll_", gsub(" ", "_", id_name), "_", setting, "_decrease_", decrease, ".csv"))
...
for (i in 1:length(info)) {
  ...
  #df_out <- read.csv(file = file.path(dir, "02_scm", "07_treated_schools_scpi_perm_roll_result_St_Peter's_Catholic_School.csv")) # debug
