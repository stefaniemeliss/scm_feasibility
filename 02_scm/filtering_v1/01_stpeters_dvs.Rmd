---
title: "St Peters school workforce census"
...
# filter swf to create outcome dataset #
...
vars <- c(
  # (1)	Workforce flow (recruitment & retention)
  #     needs to be requested by DfE
  # (2)	HC and/or FTE of all/qualified/classroom teachers
  "hc_all_teachers", "hc_classroom_teachers", # workforce
  "fte_all_teachers", "fte_classroom_teachers", # workforce
  "qualified_teachers_fte", "teachers_fte", # ptrs
  # (3)	Pupil:teacher ratio (all/qualified)
  "pupil_to_qual_teacher_ratio", "pupil_to_qual_unqual_teacher_ratio"#, # ptrs
  # (4)	Vacancies
  #"vacancy", "rate", "temprate",
  # (5)	Absences
  #"percentage_taking_absence", "average_number_of_days_all_teachers"
)
...
for (var in vars) {
  ...
  y_lab <- gsub("Hc|hc", "HC", gsub("Fte|fte", "FTE", stringr::str_to_sentence(gsub("_", " ", var))))
...
```{r, include=F}
# # save data
# write.csv(within_school_raw, file = "00_overview_stpeters_within_school_raw.csv")
# write.csv(within_school_sum, file = "00_overview_stpeters_within_school_sum.csv")
