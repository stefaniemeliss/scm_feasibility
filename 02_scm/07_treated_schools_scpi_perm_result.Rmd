...
file_name <- file.path(dir, "02_scm", "interim",  paste0("06_treated_schools_scpi_perm_", gsub(" ", "_", id_name), "_simdata.csv"))
...
# determine output filename
file_name <- file.path(dir, "02_scm", "interim", paste0("06_treated_schools_scpi_perm_", gsub(" ", "_", id_name), "_decrease_", sprintf("%.2f", decrease), ".csv"))
